...
void CResult::SetVertex(void)
{
	...
	m_pScene2D[1]->Init(D3DXVECTOR3(0.0f, 0.0f, 0.0f), SCREEN_HEIGHT, SCREEN_WIDTH);
	m_pScene2D[1]->BindTexture(m_pTexture[1]);

	//リザルトのインスタンス生成
	m_pScene2D[2] = new CScene2D;
	m_pScene2D[2]->Init(D3DXVECTOR3(0.0f, 0.0f, 0.0f), SCREEN_HEIGHT, SCREEN_WIDTH);
	m_pScene2D[2]->BindTexture(m_pTexture[2]);

	//リザルトのインスタンス生成
	m_pScene2D[3] = new CScene2D;
	m_pScene2D[3]->Init(D3DXVECTOR3(350.0f, 0.0f, 0.0f), 300.0f, 1200.0f);
	m_pScene2D[3]->BindTexture(m_pTexture[3]);

	//リザルトのインスタンス生成
	m_pScene2D[4] = new CScene2D;
	m_pScene2D[4]->Init(D3DXVECTOR3(200.0f, 350.0f, 0.0f), 150.0f, 600.0f);
	m_pScene2D[4]->BindTexture(m_pTexture[4]);

	//リザルトのインスタンス生成
	m_pScene2D[5] = new CScene2D;
	m_pScene2D[5]->Init(D3DXVECTOR3(1050.0f, 350.0f, 0.0f), 150.0f, 600.0f);
	m_pScene2D[5]->BindTexture(m_pTexture[5]);

	//リザルトのインスタンス生成
	m_pScene2D[6] = new CScene2D;
	m_pScene2D[6]->Init(D3DXVECTOR3(550.0f, 450.0f, 0.0f), 200.0f, 900.0f);
	m_pScene2D[6]->BindTexture(m_pTexture[6]);

	//リザルトのインスタンス生成
	m_pScene2D[7] = new CScene2D;
	m_pScene2D[7]->Init(D3DXVECTOR3(550.0f, 650.0f, 0.0f), 200.0f, 800.0f);
