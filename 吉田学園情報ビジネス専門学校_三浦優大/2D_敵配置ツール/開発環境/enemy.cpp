...
//エネミーの初期化処理
//=============================================================================
HRESULT CEnemy::Init(D3DXVECTOR3 pos, float fHight, float fWidth, ENEMYTYPE enemyType,float fMove,int nHoming,int nLife, int nDamage)
{
	//基本クラスの初期化処理
...
//エネミーの設定・更新処理
//=============================================================================
CEnemy * CEnemy::Create(D3DXVECTOR3 pos, float fHight, float fWidth,ENEMYTYPE enemyType,float fMove, int nHoming, int nLife, int nDamage)
{
	//インスタンス生成
	CEnemy *pEnemy;
	pEnemy = new CEnemy;
	...
	//初期化処理
	pEnemy->Init(pos, fHight, fWidth, enemyType, fMove, nHoming, nLife, nDamage);
...
//敵の状態引数
//=============================================================================
void CEnemy::SetEnemyState(ENEMY_DAMAGE_STATE damage)
{
	//値を代入
	m_pos = GetPosition();
