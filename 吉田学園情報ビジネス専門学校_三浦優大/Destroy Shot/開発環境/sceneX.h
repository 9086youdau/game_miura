...
public:
	...
	void BindTextureName(char *TextureName);                        //テクスチャのポインタ
	...
	LPD3DXMESH GetMesh(void) { return m_pGetMesh; }

private:
	LPDIRECT3DTEXTURE9	m_pTexture;		//テクスチャのポインタ
	LPD3DXMESH	m_pMesh;		//メッシュ
	static LPD3DXMESH	m_pGetMesh;		//メッシュ
	...
	static char		*m_pTextureName;	//Xファイル読み込み
