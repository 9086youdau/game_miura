...
//マクロ定義
//=============================================================================
#define DISTANCE			(700.0f)	// プレイヤー(注視点)とカメラの距離
...
void CCamera::Update(void)
{
	...
	if (nCameraType == 0)
	{
		...
		m_posV.z = pos.z + cosf(m_rot.y) *-m_fDistance - 2000.0f;
		m_posV.y = pos.y + sinf(m_rot.x) + cosf(m_rot.x) * 3000.0f;
...
void CCamera::Mouseoperation(void)
{
	...
	//開始時のカメラの角度を決める
	m_rot.y = (m_fhorizontalAngle + D3DX_PI * 2);
