...
HRESULT CMeshfield::Init(D3DXVECTOR3 pos, float fHight, float fWidth)
{
	...
	//中心を合わせる
	m_pos = D3DXVECTOR3(-(WIDTHNUM*WIDTH / 2), -2.0f, (DEPTHNUM*DEPTH / 2));
...
void CMeshfield::Load(void)
{
	...
	// テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/black-cracked-marble-floor-tile-texture_53876-104644.jpg", &m_pTexture);
}
//=============================================================================
// テクスチャアンロード設定処理
//=============================================================================
