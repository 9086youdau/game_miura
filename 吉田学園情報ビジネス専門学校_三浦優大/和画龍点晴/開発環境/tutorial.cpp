...
HRESULT CTutorial::Init(D3DXVECTOR3 pos, float fHight, float fWidth)
{
	...
	m_pScene2D[1]->Init(D3DXVECTOR3(1250.0f, 50.0f, 1.0f), 80.0f, 500.0f);
...
void CTutorial::Update(void)
{
	...
	if (m_nCount % 30 == 0)//間隔
	{
		m_pScene2D[1]->SetCol(D3DXCOLOR(255, 255, 255, 155));
	}

	else if (m_nCount % 15 == 0 && m_nCount % 30)//間隔
	{
		m_pScene2D[1]->SetCol(D3DXCOLOR(255, 255, 255, 255));
	}
