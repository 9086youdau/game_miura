...
HRESULT InitPlayer(void)
{
	...
	//テキスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/ShipType04.png", &g_pTexturePlayer[0]);

	//テキスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/ShipType05.png", &g_pTexturePlayer[1]);

	//変数初期化
	g_posPlayer.nCounterAnim = 0;
	g_posPlayer.nPatternAnim = 0;
	g_posPlayer.nseetAnim = 0;
...
void UpdatePlayer(void)
{
	...
	{
		//対角線の長さ
		g_posPlayer.fLengthPlayer = sqrtf(100 * 100 + 100 * 100);
		//対角線の角度
		g_posPlayer.fAnglePlayer = atan2f(100, 100);
		...
		{
			//回転量
			g_posPlayer.rotPlayer.z += (D3DX_PI / 18);
			if (g_posPlayer.rotPlayer.z > D3DX_PI)
			{
				g_posPlayer.rotPlayer.z -= D3DX_PI*2.0f;
			}
		}
		...
		//プレイヤーの頂点座標
		pVtx[0].pos.x = g_posPlayer.Pos.x + sinf(g_posPlayer.rotPlayer.z - g_posPlayer.fAnglePlayer) * g_posPlayer.fLengthPlayer;
		pVtx[0].pos.y = g_posPlayer.Pos.y + cosf(g_posPlayer.rotPlayer.z - g_posPlayer.fAnglePlayer) * g_posPlayer.fLengthPlayer;
		pVtx[0].pos.z = 0.0f;

		pVtx[1].pos.x = g_posPlayer.Pos.x - sinf(g_posPlayer.rotPlayer.z + g_posPlayer.fAnglePlayer) * g_posPlayer.fLengthPlayer;
		pVtx[1].pos.y = g_posPlayer.Pos.y - cosf(g_posPlayer.rotPlayer.z + g_posPlayer.fAnglePlayer) * g_posPlayer.fLengthPlayer;
		pVtx[1].pos.z = 0.0f;

		pVtx[2].pos.x = g_posPlayer.Pos.x + sinf(g_posPlayer.rotPlayer.z + g_posPlayer.fAnglePlayer) * g_posPlayer.fLengthPlayer;
		pVtx[2].pos.y = g_posPlayer.Pos.y + cosf(g_posPlayer.rotPlayer.z + g_posPlayer.fAnglePlayer) * g_posPlayer.fLengthPlayer;
		pVtx[2].pos.z = 0.0f;

		pVtx[3].pos.x = g_posPlayer.Pos.x - sinf(g_posPlayer.rotPlayer.z - g_posPlayer.fAnglePlayer) * g_posPlayer.fLengthPlayer;
		pVtx[3].pos.y = g_posPlayer.Pos.y - cosf(g_posPlayer.rotPlayer.z - g_posPlayer.fAnglePlayer) * g_posPlayer.fLengthPlayer;
		pVtx[3].pos.z = 0.0f;
