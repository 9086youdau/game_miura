...
//グローバル変数
//===============================================
LPDIRECT3DTEXTURE9 g_pTextureTutolial[3] = {};//テクスチャ設定
...
HRESULT InitTutolial(void)
{
	...
	//テキスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/キャプチャ.png", &g_pTextureTutolial[0]);
	...
	for (int nCount = 0; nCount < 3; nCount++)
	{
		...
		g_PosEnterTutolial.Pos = D3DXVECTOR3(1550.0f, 920.0f, 0.0f);
...
void SetTutolial(int nCount)
{
	...
	{
		//頂点座標の設定
		pVtx[8].pos = D3DXVECTOR3(g_PosEnterTutolial.Pos.x - (300 / 2), g_PosEnterTutolial.Pos.y + (200 / 2), 0.0f);//2Dは0.0固定
		pVtx[9].pos = D3DXVECTOR3(g_PosEnterTutolial.Pos.x - (300 / 2), g_PosEnterTutolial.Pos.y - (200 / 2), 0.0f);
		pVtx[10].pos = D3DXVECTOR3(g_PosEnterTutolial.Pos.x + (600 / 2), g_PosEnterTutolial.Pos.y + (200 / 2), 0.0f);
		pVtx[11].pos = D3DXVECTOR3(g_PosEnterTutolial.Pos.x + (600 / 2), g_PosEnterTutolial.Pos.y - (200 / 2), 0.0f);//2Dは0.0固定
	}
