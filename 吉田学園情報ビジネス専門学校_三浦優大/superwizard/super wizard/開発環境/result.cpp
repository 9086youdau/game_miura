...
HRESULT InitResult(void)
{
	...
	//if (nCntEnemy > 0)
	{
		D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/c233e101-s.jpg", &g_pTextureResult[1]);
	}

	//else if (nCntEnemy <= 0)
	{
		D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/ゲームオーバー.png", &g_pTextureResult[1]);
	}
