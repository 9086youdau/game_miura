...
HRESULT InitTimer(void)
{
	...
	//頂点バッファの生成
	if (FAILED(pDevice->CreateVertexBuffer(sizeof(VERTEX_2D) * 4 * MAX_TIMER,
		D3DUSAGE_WRITEONLY,
		FVF_VERTEX_2D,
		D3DPOOL_MANAGED,
		&g_pVtxBuffTimer,
	...
	{
		g_aTimer[nCntTimer] = D3DXVECTOR3(1690, 100, 0.0f);
...
void UpdateTimer(void)
{
	...
	nNumber[0] = g_nTimer.nTimer % 1000 / 100;
	nNumber[1] = g_nTimer.nTimer % 100 / 10;
	nNumber[2] = g_nTimer.nTimer % 10 / 1;
