...
private:
	...
	static float	m_aOffset[MODEL_PARTS][6];				//モデルの位置向きを設置
	...
	float					m_Player3D[MOTIONTYPE_MAX][10][MODEL_PARTS][6];		//各モーションの位置向きを記憶場所
	...
	static char             *m_SelectData[MODEL_PARTS + 1][256];                   //デバックログ表示用
